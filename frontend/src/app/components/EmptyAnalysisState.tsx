    ...
    <div className="flex-1 flex items-center justify-center p-8">
      <div className="max-w-2xl w-full text-center">
        <div className="inline-flex p-6 rounded-full bg-white/5 mb-6">
          <FileBarChart className="w-16 h-16 text-white/40" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-12">
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 text-left">
            ...
            <h3 className="text-white font-medium mb-2">Upload Dataset</h3>
          ...
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 text-left">
            ...
            <h3 className="text-white font-medium mb-2">Use Existing Data</h3>
            <p className="text-sm text-white/60">
